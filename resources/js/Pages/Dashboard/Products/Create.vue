...
<template>
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                <h1 class="text-xl font-semibold tracking-tight text-slate-900">Add Product</h1>
                <p class="mt-0.5 text-sm text-slate-500">Create a new product for your shop</p>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="rounded-2xl border border-line bg-white p-6 shadow-sm">
                ...
                <p class="mt-0.5 text-sm text-slate-500">Add photos of your product</p>
                <div class="mt-5">
                    <ImageUpload
                        v-model="form.images"
                        :max-images="5"
